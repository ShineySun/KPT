...
'''
python tools/inference_cam.py --cfg experiments/coco/inference_demo_coco.yaml \
    --videoFile input_video/test_2.mp4 \
    --outputDir output \
    --visthre 0.3 \
...
def main():
    ...
    print("current_path : {}".format(os.getcwd()))
    print("args.videoFile : {}".format(args.videoFile))

    # Loading an video
    vidcap = cv2.VideoCapture(os.getcwd()+args.videoFile)
